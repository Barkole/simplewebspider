...
public final class Punycode {
	...
	public final static int digit2codepoint(final int d) throws PunycodeException {
		if (d < 26) {
			// 0..25 : 'a'..'z'
			return d + 'a';
		} else if (d < 36) {
	...
	public final static int codepoint2digit(final int c) throws PunycodeException {
		if (c - '0' < 10) {
			// '0'..'9' : 26..35
			return c - '0' + 26;
		} else if (c - 'a' < 26) {
